...
return [
    ...
    */
    ...
    'ai' => [
        ...
        'final_decision_max_payload_kb' => (int) env('AI_FINAL_DECISION_MAX_PAYLOAD_KB', 120),
        'final_decision_timeout_seconds' => (int) env('AI_FINAL_DECISION_TIMEOUT_SECONDS', env('AI_AGENT_TIMEOUT_SECONDS', 90)),
