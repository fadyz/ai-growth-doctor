...
class FinalDecisionAgent
{
    ...
    private function compactStructuredNegotiation(array $negotiation): array
    {
        return [
            ...
            'conflicts' => array_slice($negotiation['conflicts'] ?? [], 0, 6),
            'conflict_matrix' => array_slice($negotiation['conflicts'] ?? [], 0, 6),
