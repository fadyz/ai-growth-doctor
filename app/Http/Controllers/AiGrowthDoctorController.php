...
class AiGrowthDoctorController extends Controller
{
    ...
    private function emptyDashboardAnalysis(): array
    {
        return [
            ...
            'tomorrow_forecast_context_mode' => null,
            'metrics' => [
                'activation_metrics' => [],
                'retention_metrics' => [],
    ...
    public function analyzeCheckpoint(?string $trackedRunId = null): array
    {
        ...
        $analysis = [
            ...
            'agent_request_metrics' => $orchestration['agent_request_metrics'] ?? [],
            'tomorrow_forecast_context_mode' => $orchestration['tomorrow_forecast_context_mode'] ?? null,
    ...
    private function compactSummaryPayload(array $analysis, ?string $auditPath): array
    {
        ...
        return [
            ...
            'interaction_log' => [],
            'agent_request_metrics' => $analysis['agent_request_metrics'] ?? [],
            'tomorrow_forecast_context_mode' => $analysis['tomorrow_forecast_context_mode'] ?? null,
    ...
    private function compactAgents(array $agents): array
    {
        ...
        foreach ($agents as $key => $agent) {
            ...
            $compact[$key] = [
                ...
                'request_metrics' => $agent['request_metrics'] ?? null,
                'response_metrics' => $agent['response_metrics'] ?? null,
